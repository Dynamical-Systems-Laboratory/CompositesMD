...
msd_plot_and_save('eq_aem_water_diff', 'processed_eq_aem_water_diff', wfig)
msd_plot_and_save('eq_aem_ion_diff', 'processed_eq_aem_ion_diff', ifig)
...
function msd_plot_and_save(post_fin, post_fout, jfig)
    ...
    msd_fig(xx, yx, dyx,[174/255, 229/255, 183/255],[40/255, 182/255, 40/255], jfig, '$\mathrm{MSD}\left(x\right)$, $\left[\mathrm{\AA^2}\right]$')
    ...
    msd_fig(xy,yy,dyy,[180/255, 209/255, 223/255],[17/255, 122/255, 175/255], jfig+1, '$\mathrm{MSD}\left(y\right)$, $\left[\mathrm{\AA^2}\right]$')
    ...
    msd_fig(xz,yz,dyz,[229/255, 163/255, 172/255],[201/255, 31/255, 54/255], jfig+2, '$\mathrm{MSD}\left(z\right)$, $\left[\mathrm{\AA^2}\right]$')
